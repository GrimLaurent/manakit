...
import { GridRowClassType } from './GridRow.type';
...
const GridRow: FunctionComponent<GridRowClassType> = ({
  id,
  className,
  style,
  children,
  ...
  return (
    <Fragment>
      <div id={id} className={useClassName(`k-grid--row`, className, classList)} style={useStyle({}, style)}>
        {children}
      </div>
    </Fragment>
  );
