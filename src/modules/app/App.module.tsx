...
const App: FunctionComponent<AppType> = ({ theme, className, style, children, dark, light, noSSR }) => {
  if (noSSR) {
    ...
    useEffect(() => {
      ...
      setRender(
        <Structural theme={theme} className={className} style={style} dark={dark} light={light}>
          {children}
        </Structural>,
      );
    }, []);
